...
public class LZWApp {
    ...
    public LZWApp() {
        frame = new Frame("HUFFMAN Compression/Decompression");
        ...
        // Header Label
        headerLabel = new Label("HUFFMAN Technique");
        ...
        compressButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (selectedFile != null) {
                    huffman.compress(selectedFile.getAbsolutePath());
        ...
        decompressButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (selectedFile != null) {
                    huffman.decompress(selectedFile.getAbsolutePath());
